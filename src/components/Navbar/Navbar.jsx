    ...
    >
      <div className="flex items-center justify-between py-5 text-white">
        ...
        <div className="text-lg font-semibold cursor-pointer">
          ...
          <span className="text-white">Simplice</span>
          <span className="text-[#8245ec]">/</span>
          <span className="text-white">SODEGLA</span>
          <span className="text-[#8245ec]">&gt;</span>
        </div>
        ...
        <ul className="hidden space-x-8 text-gray-300 md:flex">
          ...
          {menuItems.map((item) => (
              <li key={item.id}>
                {item.path ? (
                  <Link to={item.path} className="hover:text-[#8245ec]">
                    {item.label}
                  </Link>
                ) : (
                  <button
